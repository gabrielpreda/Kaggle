    ...
    for n_fold, (train_idx, valid_idx) in enumerate(folds.split(train_df[feats], train_df['TARGET'])):
        with timer("K-Fold"):
            ...
            clf = LGBMClassifier(nthread=-1,
                  n_estimators=5000,
                  learning_rate=0.00786587,
                  num_leaves=60,
                  colsample_bytree=0.521758529,
                  subsample=0.78513993,
                  reg_alpha=0.68423885,
                  reg_lambda=0.53941318,
...
if __name__ == "__main__":
    submission_file_name = "submission_2018082001.csv"
